...
import 'package:thc/agora/broadcasting/video_call_page.dart';
...
class _PreJoiningDialogState extends State<PreJoiningDialog> {
  ...
  Future<void> _joinCall() async {
    ...
    final appId = AgoraCredentials.appId;
    if (appId == null) {
      throw Exception('Please add your APP_ID to credentials file');
    }
